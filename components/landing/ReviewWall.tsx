...
// Sprint 0 item 5b: nine reviews in the server-rendered marquee (each row is
// drawn twice for the loop), the rest behind a click in ReviewWallMore.
const WALL = 9
const ROW_ONE = MIXED.slice(0, 5)
