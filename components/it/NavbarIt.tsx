...
import { nav, SIGNUP_URL, SIGNIN_URL } from '@/lib/i18n/it'

// Italian navbar. Same layout and breakpoints as components/Navbar.tsx (the
// hamburger stays until lg so tablets do not wrap), Italian labels, and the
// EN switch beside "Accedi".
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 backdrop-blur-xl ${
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center justify-between h-20">
            <Link href="/it" className="flex-shrink-0" onClick={() => setIsMobileMenuOpen(false)} aria-label={nav.homeAria}>
      ...
      <div className={`fixed inset-0 z-40 lg:hidden transition-all duration-300 ${
        ...
        <div className={`absolute top-20 left-0 right-0 bg-white border-b border-slate-200 shadow-xl transition-transform duration-300 ${
          ...
          <div className="px-6 py-4 space-y-1">
            ...
            <LanguageSwitcherInline current="it" />
          </div>
