...
// is set on the server for every /pt-br/ page (the English layout in app/(en)
...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Giggal.ai - Verificação de e-mail grátis, domínios catch-all incluídos',
    template: '%s | Giggal.ai',
  },
  description:
    'Verificação de e-mail grátis para domínios catch-all e accept-all com 98,5 % de precisão. Limpe sua lista, reduza os bounces e proteja a reputação do remetente.',
...
export default function PortugueseRootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="pt-BR" className={`scroll-smooth ${jakarta.variable} ${jetbrainsMono.variable}`}>
      <head>
