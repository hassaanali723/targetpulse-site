    ...
    <main className="relative min-h-screen bg-slate-50 grid-lines overflow-x-hidden text-slate-800 antialiased">
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24">
        <div className="bg-white border-2 border-slate-200 rounded-3xl p-6 sm:p-8 md:p-10 card-vivid-shadow [&_strong]:font-bold [&_strong]:text-slate-900">
          ...
          <h3 className="text-lg md:text-xl font-bold text-slate-900 mt-6 mb-3">2.1 Email Verification Service</h3>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h3 className="text-lg md:text-xl font-bold text-slate-900 mt-6 mb-3">2.2 Credit-Based System</h3>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h3 className="text-lg md:text-xl font-bold text-slate-900 mt-6 mb-3">2.3 Service Features</h3>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">3. User Account</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">4. Payment Terms</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h3 className="text-lg md:text-xl font-bold text-slate-900 mt-6 mb-3">4.1 Credit Purchase Options</h3>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h3 className="text-lg md:text-xl font-bold text-slate-900 mt-6 mb-3">4.2 Pricing and Billing</h3>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h3 className="text-lg md:text-xl font-bold text-slate-900 mt-6 mb-3">4.3 Free Trial Credits</h3>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">5. Recurring Subscription Services</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">6. Credit Usage and Management</h2>

          <h3 className="text-lg md:text-xl font-bold text-slate-900 mt-6 mb-3">6.1 Credit Consumption</h3>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h3 className="text-lg md:text-xl font-bold text-slate-900 mt-6 mb-3">6.2 Credit Validity and Transfer</h3>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">8. Acceptable Use Policy</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">9. Service Accuracy and Limitations</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">10. Lawful Use and Messaging Compliance</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">11. Intellectual Property</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">12. Data and Privacy</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">13. Service Modifications and Availability</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">14. Limitation of Liability</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">15. Disclaimer of Warranties</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">16. Indemnification</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">17. Termination</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">18. Governing Law</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">19. Dispute Resolution</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">20. Changes to Terms</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
            We reserve the right to modify or replace these Terms at any time at our sole discretion. If a revision is material, we will provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material change will be determined at our sole discretion.
          </p>

          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">21. Severability</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
            If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law, and the remaining provisions will continue in full force and effect.
          </p>

          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">22. Contact Information</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
