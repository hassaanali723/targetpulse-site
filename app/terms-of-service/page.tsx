        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <div className="prose prose-lg max-w-none">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">2.1 Email Verification Service</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">2.2 Credit-Based System</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">2.3 Service Features</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">4.1 Credit Purchase Options</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">5. Recurring Subscription Services</h2>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">6. Credit Usage and Management</h2>
              
              <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">6.1 Credit Consumption</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">6.2 Credit Validity and Transfer</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">8. Acceptable Use Policy</h2>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">9. Service Accuracy and Limitations</h2>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">13. Service Modifications and Availability</h2>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">22. Contact Information</h2>
              <p className="text-slate-700 mb-4">
