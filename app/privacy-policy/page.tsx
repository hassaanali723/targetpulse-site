        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <div className="prose prose-lg max-w-none">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">5.1 Service Providers</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">5.2 Legal Requirements</h3>
              <p className="text-slate-700 mb-4">
                We may disclose your information if required to do so by law or in response to valid requests by public authorities (e.g., court orders, subpoenas).
              </p>

              <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">5.3 Business Transfers</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">12. International Data Transfers</h2>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">13. California Privacy Rights (CCPA)</h2>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">14. Changes to This Privacy Policy</h2>
              <p className="text-slate-700 mb-4">
                We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page and updating the "Last Updated" date. You are advised to review this Privacy Policy periodically for any changes.
              </p>

              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">15. Contact Us</h2>
              <p className="text-slate-700 mb-4">
