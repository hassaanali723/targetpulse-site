...
const cfg: AltPageConfig = {
  ...
  desc: 'Scrubby resolves catch-all and SEG too, at $0.008 a credit and 3 credits per catch-all, with a million priced by quote. Giggal.ai is $9.90 per 10,000 and 1.5 credits per catch-all, every tier published. 1,000 free credits, no card.',
  h1Article: 'A',
  h1Tail: 'with flat, published pricing',
  heroP:
    'Scrubby specialises in validating catch-all and SEG-protected addresses, and so does Giggal.ai. They differ on price and credit cost. Scrubby is $0.008 a credit, $80 per 10,000, and its deep catch-all check is 3 credits per email. Giggal.ai is $9.90 per 10,000 and resolves catch-all at 1.5 credits.',
  bluf: [
    { k: 'Catch-all', v: 'Both resolve it. Scrubby bills 3 credits per catch-all; we charge 1.5.' },
  ...
  catchAllProse:
    'Scrubby and Giggal.ai take the same stand on the hard addresses: both validate catch-all and SEG-protected mailboxes that other tools return as unknown. Where they part is cost. Scrubby resolves catch-all through a deep check billed at 3 credits per email, and at $0.008 a credit that is roughly $0.024 each. Giggal.ai resolves catch-all at 1.5 credits from a $9.90-per-10,000 base.',
  pricingHeading: 'Scrubby pricing vs Giggal.ai',
  pricingProse:
    'Scrubby pay-as-you-go is a flat $0.008 a credit, $80 at 10,000 and $800 at 100,000; a million is priced on an enterprise demo call. Giggal.ai is $9.90, $76 and $680 at those volumes, published in full. On catch-all specifically, Giggal.ai charges 1.5 credits per address against Scrubby’s 3.',
