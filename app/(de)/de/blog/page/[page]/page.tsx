...
export function generateStaticParams() {
  return blogPagedParams('de')
}

export function generateMetadata({ params }: { params: { page: string } }): Metadata {
  return blogIndexPagedMetadata('de', Number(params.page))
}

export default function Page({ params }: { params: { page: string } }) {
  const page = Number(params.page)
  if (!Number.isInteger(page) || page < 2 || page > totalBlogPages(getAllPosts('de').length)) notFound()
  return <BlogIndexL10n locale="de" page={page} />
}
