...
// Root layout for the German site, so that <html lang="de">
// is set on the server for every /de/ page (the English layout in app/(en)
...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Giggal.ai - E-Mail-Adresse kostenlos prüfen, auch Catch-all',
    template: '%s | Giggal.ai',
  },
  description:
    'Kostenlose E-Mail-Prüfung für Catch-all- und Accept-all-Domains mit 98,5 % Genauigkeit. Listen bereinigen, Bounces senken, Absenderreputation schützen.',
...
export default function GermanRootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="de" className={`scroll-smooth ${jakarta.variable} ${jetbrainsMono.variable}`}>
      <head>
