...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/alternatives`, lastModified: '2026-08-02' },
    { url: `${baseUrl}/zerobounce-alternative`, lastModified: '2026-08-02' },
    { url: `${baseUrl}/neverbounce-alternative`, lastModified: '2026-08-02' },
    { url: `${baseUrl}/bounceban-alternative`, lastModified: '2026-08-02' },
    { url: `${baseUrl}/millionverifier-alternative`, lastModified: '2026-08-02' },
    { url: `${baseUrl}/reoon-alternative`, lastModified: '2026-08-02' },
    { url: `${baseUrl}/debounce-alternative`, lastModified: '2026-08-02' },
