    ...
    endpoints: [
      {
        ...
        description: 'Kick off deep catch-all verification for a completed bulk job. Only addresses flagged as catch-all in the source job are re-checked. Billed at 1 credit per address (see creditsRequired in the response).',
        bodyParams: [
