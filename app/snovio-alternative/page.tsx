...
const cfg: AltPageConfig = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: 'Snov.io flags catch-all without confirming the mailbox. Giggal.ai returns a real deliverable or undeliverable result, at 1.5 credits in a run or 2 standalone.',
    },
    {
