...
export function generateStaticParams() {
  return blogPagedParams('fr')
}

export function generateMetadata({ params }: { params: { page: string } }): Metadata {
  return blogIndexPagedMetadata('fr', Number(params.page))
}

export default function Page({ params }: { params: { page: string } }) {
  const page = Number(params.page)
  if (!Number.isInteger(page) || page < 2 || page > totalBlogPages(getAllPosts('fr').length)) notFound()
  return <BlogIndexL10n locale="fr" page={page} />
}
