...
// is set on the server for every /fr/ page (the English layout in app/(en)
...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Giggal.ai - Vérifier une adresse mail gratuitement, domaines catch-all compris',
    template: '%s | Giggal.ai',
  },
  description:
    'Vérification d’email gratuite pour les domaines catch-all et accept-all avec 98,5 % de précision. Nettoyez votre liste, réduisez les rebonds et protégez votre réputation d’expéditeur.',
...
export default function FrenchRootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="fr" className={`scroll-smooth ${jakarta.variable} ${jetbrainsMono.variable}`}>
      <head>
