...
export default function NotFoundFr() {
  const { notFound: t, home } = getStrings('fr')
  return (
    <main className="relative min-h-screen bg-slate-50 grid-lines overflow-x-hidden text-slate-800 antialiased">
      ...
      <section className="max-w-3xl mx-auto px-6 pt-32 pb-24 text-center space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <Link href="/fr/verifier-adresse-mail" className="px-8 py-3.5 bg-indigo-600 hover:bg-indigo-700 font-extrabold rounded-xl text-white shadow-md shadow-indigo-600/10 transition-all text-sm">
            {t.primary}
          </Link>
