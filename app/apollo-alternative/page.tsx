...
const cfg: AltPageConfig = {
  ...
  heroP:
    'Apollo is a sales-intelligence platform, and verification is one feature of a large contact database and outreach suite. It markets catch-all resolution at 91%. Giggal.ai is a dedicated verifier that resolves catch-all at 99% and verifies behind secure email gateways, pay-as-you-go from $9.90 per 10,000 with no per-seat cost.',
  bluf: [
    { k: 'Focus', v: 'Apollo is a database and sales platform; we are a dedicated verifier, and add SEG.' },
    { k: 'Catch-all', v: 'Apollo claims 91% on catch-all; we resolve it at 99% and verify behind SEGs too.' },
  ...
  catchAllProse:
    'Apollo runs its own catch-all handling and markets a process that distinguishes valid from invalid on catch-all domains, at a stated 91% accuracy, though it still keeps a Catch-all label. Giggal.ai resolves catch-all at 99% and goes further to verify addresses behind secure email gateways such as Mimecast, Proofpoint and Barracuda, which Apollo does not cover.',
  ...
  faqs: [
    {
      ...
      a: 'If verification is what you need, yes. Giggal.ai is a dedicated verifier that resolves catch-all at 99% and verifies behind secure email gateways, pay-as-you-go from $9.90 per 10,000. Apollo is a full contact database and sales-engagement platform, which Giggal.ai is not.',
    },
    {
      q: 'Does Apollo resolve catch-all?',
      a: 'Apollo markets a process that distinguishes valid from invalid on catch-all domains, at a stated 91% accuracy, while still keeping a Catch-all label. Giggal.ai resolves catch-all at 99% and also verifies behind secure email gateways, which Apollo does not.',
    },
    {
