...
const cfg: AltPageConfig = {
  ...
  bluf: [
    ...
    { k: 'Metering', v: 'Listmint splits standard and catch-all credits into two pools. We use one pool, at 1.5 credits per catch-all.' },
  ...
  faqs: [
    {
      ...
      a: 'Yes, and they are close on the core idea. Both resolve catch-all addresses to a real result rather than labelling them. Giggal.ai bills catch-all from a single credit balance at 1.5 credits, publishes a flat price list starting at $9.90 per 10,000, and also verifies behind 15 named secure email gateways.',
    },
    {
    ...
    },
    {
      ...
      a: '$9.90 for 10,000, $76 for 100,000 and $680 for a million, bought once with no subscription. Credits never expire, and catch-all costs 1.5 credits inside a run or 2 standalone.',
    },
    {
