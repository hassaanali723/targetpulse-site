    ...
    <main className="relative min-h-screen bg-slate-50 grid-lines overflow-x-hidden text-slate-800 antialiased">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-28 md:pt-32 pb-12 text-center space-y-6">
        <div className="inline-flex items-center gap-2 rounded-full border border-indigo-100 bg-indigo-50/80 px-4 py-1.5">
          ...
          <span className="text-[11px] font-black tracking-[0.16em] text-indigo-700 uppercase">Refund Policy</span>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24">
        <div className="bg-white border-2 border-slate-200 rounded-3xl p-6 sm:p-8 md:p-10 card-vivid-shadow [&_strong]:font-bold [&_strong]:text-slate-900">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 first:mt-0 scroll-mt-28">1. Overview</h2>
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">2. How Our Credit System Works</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">3. Free Trial Credits</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">4. Credit Purchase Refund Policy</h2>

          <h3 className="text-lg md:text-xl font-bold text-slate-900 mt-6 mb-3">4.1 Pay-As-You-Go Credits (One-Time Purchase)</h3>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h3 className="text-lg md:text-xl font-bold text-slate-900 mt-6 mb-3">4.2 Recurring Credit Subscriptions</h3>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">5. Exceptional Circumstances and Support</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">7. Account Termination and Violations</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">8. How to Request a Refund or Report Issues</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">9. Refund Processing Timeline</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">10. Chargebacks</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">11. Credit Transfers and Account Sharing</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">12. Changes to This Policy</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mt-10 mb-4 scroll-mt-28">13. Contact Information</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
