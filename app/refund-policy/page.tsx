        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <div className="prose prose-lg max-w-none">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">3. Free Trial Credits</h2>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">4. Credit Purchase Refund Policy</h2>
              
              <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">4.1 Pay-As-You-Go Credits (One-Time Purchase)</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">4.2 Recurring Credit Subscriptions</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">5. Exceptional Circumstances and Support</h2>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">7. Account Termination and Violations</h2>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">8. How to Request a Refund or Report Issues</h2>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">9. Refund Processing Timeline</h2>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">10. Chargebacks</h2>
              <p className="text-slate-700 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">11. Credit Transfers and Account Sharing</h2>
              <p className="text-slate-700 mb-4">
