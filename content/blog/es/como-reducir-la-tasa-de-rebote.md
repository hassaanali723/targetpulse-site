...
Esto no reduce los rebotes directamente, y conviene decirlo claro, porque se recomienda constantemente como solución a los rebotes. SPF, DKIM y DMARC controlan si los servidores receptores confían en que eres quien dices ser. Si los configuras mal, los mensajes se rechazan o van a spam, lo que en algunos informes aparece junto a los rebotes y enturbia el diagnóstico.

Configúralos bien, compruébalos una vez con cualquiera de los verificadores de DMARC gratuitos, y deja de pensar en ellos. Si tus rebotes son errores de buzón inexistente, ningún trabajo de DNS te ayudará.
