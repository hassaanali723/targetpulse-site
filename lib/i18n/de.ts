...
export const footer = {
  ...
  resources: {
    ...
    links: [
      ...
      { name: 'Hunter Alternative', href: '/de/hunter-alternative' },
      { name: 'Snov.io Alternative', href: '/de/snovio-alternative' },
      { name: 'Instantly Alternative', href: '/de/instantly-alternative' },
